...
save_points=false;
    ...
    mimFrameRGB.resize(mVideoSource.Size()*3);
...
//fprintf(stderr,"stamp%lf\n",time_sec);
	...
	mpTracker->TrackFrame(mimFrameRGB, mimFrameBW, !bDrawAR && !bDrawMap,pos_x,pos_y,first_kf,second_kf);
...
/*
                  ...
                  ofs2 << mpTracker->mse3CamFromWorld<< endl;
                  ofs2.close();*/
i++;
