...
struct KeyFrame
{
  ...
  CVD::Image<CVD::Rgb<CVD::byte> > imRGB; // RGB image - required for image segmentation
  ...
  void MakeKeyFrame_Lite(CVD::BasicImage<CVD::Rgb<CVD::byte> > &imRGB, CVD::BasicImage<CVD::byte> &im);   // This takes an image and calculates pyramid levels etc to fill the 
